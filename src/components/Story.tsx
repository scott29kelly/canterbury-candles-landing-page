...
const steps = [
  {
    number: "01",
    title: "Source",
    description: "Premium coconut and soy wax, carefully selected for clean, even burns.",
  ...
  },
  {
    number: "02",
    title: "Melt",
    description: "Wax heated in stainless steel pots to the precise temperature for optimal scent throw.",
  ...
  },
  {
    number: "03",
    title: "Pour",
    description: "Each 16oz mason jar hand-poured and wicked with care. No shortcuts, no machines.",
  ...
  },
  {
    number: "04",
    title: "Cure",
    description: "Two weeks of curing for maximum fragrance. Patience is the final ingredient.",
      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
        <div className="mb-20 max-w-xl lg:mb-28">
          ...
          <p className="mt-6 max-w-md font-[family-name:var(--font-dm-sans)] text-base leading-relaxed font-light text-bark-600">
            Every Canterbury candle begins as raw wax and ends as something worth savoring. Here&apos;s what happens in between.
          </p>
        </div>
        ...
        <div className="mt-28 grid grid-cols-1 items-center gap-12 lg:mt-40 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-6 max-w-md font-[family-name:var(--font-dm-sans)] text-base leading-relaxed font-light text-bark-600">
              Each candle is hand-poured into a 16oz mason jar and sealed with a
              bronze lid. The coconut/soy blend burns cleaner and throws scent
              farther than paraffin alternatives.
            </p>
