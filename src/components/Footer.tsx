...
export default function Footer() {
  return (
    <footer className="bg-forest-deep py-16 sm:py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center sm:items-start gap-4">
            ...
            />
            <p className="text-cream/30 text-xs tracking-[0.15em] max-w-xs text-center sm:text-left">
              Hand-poured coconut &amp; soy blend candles. Small batch,
              artisan-made.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center sm:items-end gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 text-cream/40 hover:text-bronze transition-colors text-sm"
            >
            ...
            <nav className="flex gap-6 text-cream/30 text-xs tracking-[0.15em] uppercase">
              <a
                href="#scents"
